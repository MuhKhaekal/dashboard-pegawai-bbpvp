...
export default async function DashboardPage() {
  ...
  // --- 2. ANALITIK UMUR, PENSIUN, KENAIKAN PANGKAT, GENERASI & MASA KERJA ---
  ...
  const topBidang = Object.entries(distribusiBidang).sort((a, b) => b[1] - a[1]).slice(0, 5);
    ...
    <div className="p-4 md:p-6 lg:p-10 max-w-7xl mx-auto space-y-6 lg:space-y-8 bg-slate-50/50 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 animate-fade-up delay-100">
        ...
        <div className="glass-card p-6 lg:p-7 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group hover:border-emerald-300 transition-all hover:shadow-lg">
          <div className="flex justify-between items-start mb-4">
            <div>
              <p className="text-gray-400 font-bold tracking-wider text-[10px] lg:text-xs mb-1 uppercase">PNS</p>
              <h3 className="text-3xl lg:text-4xl font-black text-gray-800">{totalPNS}</h3>
            </div>
            <div className="p-2 lg:p-2.5 bg-emerald-50 rounded-xl text-emerald-500 group-hover:rotate-12 transition-transform">
          ...
          <div className="space-y-2 lg:space-y-2.5 pt-3 lg:pt-4 border-t border-gray-100">
            <div className="flex justify-between text-[10px] lg:text-xs font-bold text-gray-500 group-hover:text-emerald-700 transition-colors">
              <span>BBPVP Pusat</span>
              <span className="bg-emerald-50 px-2 py-0.5 rounded">{pnsPusat}</span>
            </div>
            <div className="flex justify-between text-[10px] lg:text-xs font-bold text-gray-500 group-hover:text-emerald-700 transition-colors">
              <span>SATPEL</span>
              <span className="bg-emerald-50 px-2 py-0.5 rounded">{pnsSatpel}</span>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card p-6 lg:p-7 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group hover:border-blue-300 transition-all hover:shadow-lg flex flex-col justify-between">
          <div className="flex justify-between items-start mb-4">
            <div>
              <p className="text-gray-400 font-bold tracking-wider text-[10px] lg:text-xs mb-1 uppercase">PPPK</p>
              <h3 className="text-3xl lg:text-4xl font-black text-gray-800">{totalPPPK}</h3>
            </div>
            <div className="p-2 lg:p-2.5 bg-blue-50 rounded-xl text-blue-500 group-hover:-rotate-12 transition-transform">
              <svg className="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="w-full bg-gray-100 rounded-full h-2 mb-2 overflow-hidden">
            <div className="bg-blue-500 h-full rounded-full" style={{ width: `${pppkPct}%` }}></div>
          </div>
        ...
        <div className="glass-card p-6 lg:p-7 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group hover:border-amber-300 transition-all hover:shadow-lg flex flex-col justify-between">
          <div className="flex justify-between items-start mb-4">
            <div>
              <p className="text-gray-400 font-bold tracking-wider text-[10px] lg:text-xs mb-1 uppercase">Non ASN</p>
              <h3 className="text-3xl lg:text-4xl font-black text-gray-800">{totalNonASN}</h3>
            </div>
            <div className="p-2 lg:p-2.5 bg-amber-50 rounded-xl text-amber-500 group-hover:scale-110 transition-transform">
              <svg className="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="w-full bg-gray-100 rounded-full h-2 mb-2 overflow-hidden">
            <div className="bg-amber-500 h-full rounded-full" style={{ width: `${nonAsnPct}%` }}></div>
          </div>
      ...
      <div className="animate-fade-up delay-200 glass-card p-5 md:p-8 rounded-3xl shadow-sm border border-gray-100 group">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 lg:gap-4 mt-4 lg:mt-6">
          <div className="p-3 lg:p-4 rounded-xl lg:rounded-2xl bg-slate-50 border border-slate-100 hover:border-[#15406A] transition-colors">
            <p className="text-[9px] lg:text-[10px] uppercase font-bold text-gray-400 flex items-center">
              <span className="w-1.5 lg:w-2 h-1.5 lg:h-2 rounded-full bg-[#15406A] mr-1.5 lg:mr-2"></span>Boomer (≤1964)
            </p>
            <p className="text-xl lg:text-2xl font-black text-gray-800 mt-1">
              {generasiStats["Baby Boomer"]} <span className="text-[10px] lg:text-xs text-gray-500 font-medium ml-1">Org</span>
            </p>
          </div>
          <div className="p-3 lg:p-4 rounded-xl lg:rounded-2xl bg-slate-50 border border-slate-100 hover:border-blue-500 transition-colors">
            <p className="text-[9px] lg:text-[10px] uppercase font-bold text-gray-400 flex items-center">
              <span className="w-1.5 lg:w-2 h-1.5 lg:h-2 rounded-full bg-blue-500 mr-1.5 lg:mr-2"></span>Gen X (1965-1980)
            </p>
            <p className="text-xl lg:text-2xl font-black text-gray-800 mt-1">
              {generasiStats["Gen X"]} <span className="text-[10px] lg:text-xs text-gray-500 font-medium ml-1">Org</span>
            </p>
          </div>
          <div className="p-3 lg:p-4 rounded-xl lg:rounded-2xl bg-slate-50 border border-slate-100 hover:border-emerald-400 transition-colors">
            <p className="text-[9px] lg:text-[10px] uppercase font-bold text-gray-400 flex items-center">
              <span className="w-1.5 lg:w-2 h-1.5 lg:h-2 rounded-full bg-emerald-400 mr-1.5 lg:mr-2"></span>Milenial (1981-1996)
            </p>
            <p className="text-xl lg:text-2xl font-black text-gray-800 mt-1">
              {generasiStats["Milenial"]} <span className="text-[10px] lg:text-xs text-gray-500 font-medium ml-1">Org</span>
            </p>
          </div>
          <div className="p-3 lg:p-4 rounded-xl lg:rounded-2xl bg-slate-50 border border-slate-100 hover:border-amber-400 transition-colors">
            <p className="text-[9px] lg:text-[10px] uppercase font-bold text-gray-400 flex items-center">
              <span className="w-1.5 lg:w-2 h-1.5 lg:h-2 rounded-full bg-amber-400 mr-1.5 lg:mr-2"></span>Gen Z (≥1997)
            </p>
            <p className="text-xl lg:text-2xl font-black text-gray-800 mt-1">
              {generasiStats["Gen Z"]} <span className="text-[10px] lg:text-xs text-gray-500 font-medium ml-1">Org</span>
            </p>
          </div>
        </div>
      </div>

      {/* BARIS 3: ANALITIK HR (Umur & Masa Kerja) */}
            ...
            {Object.entries(usiaStats).map(([range, count], idx) => {
              ...
              return (
                <div key={idx} className="group relative">
                  ...
                  <div className="w-full bg-gray-100 rounded-full h-2.5 lg:h-3.5 overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-teal-400 to-teal-600 rounded-full animate-bar" style={{ width: `${widthPct}%` }}></div>
                  </div>
                </div>
              );
            })}
        ...
        <div className="glass-card rounded-3xl shadow-sm border border-gray-100 p-6 lg:p-8 flex flex-col md:flex-row items-center gap-6 lg:gap-8">
          <div className="flex-1 w-full order-2 md:order-1">
            <h2 className="text-base lg:text-lg font-bold text-gray-800 mb-1 lg:mb-2 flex items-center">
              <span className="w-2.5 lg:w-3 h-5 lg:h-6 bg-pink-500 rounded-full mr-2 lg:mr-3"></span> Masa Mengabdi (ASN)
            </h2>
            ...
            <div className="space-y-3 lg:space-y-4 w-full">
              <div className="flex justify-between items-center text-xs lg:text-sm">
                <div className="flex items-center">
                  <span className="w-2.5 lg:w-3 h-2.5 lg:h-3 rounded-full bg-purple-500 mr-2 lg:mr-3"></span>
                  <span className="font-semibold text-gray-600">Baru (0-5 Thn)</span>
                </div>
                <span className="font-bold bg-gray-100 px-2 rounded">{masaKerjaStats["< 5 Thn"]}</span>
              </div>
              <div className="flex justify-between items-center text-xs lg:text-sm">
                <div className="flex items-center">
                  <span className="w-2.5 lg:w-3 h-2.5 lg:h-3 rounded-full bg-pink-500 mr-2 lg:mr-3"></span>
                  <span className="font-semibold text-gray-600">Berkembang (5-10 Thn)</span>
                </div>
                <span className="font-bold bg-gray-100 px-2 rounded">{masaKerjaStats["5-10 Thn"]}</span>
              </div>
              <div className="flex justify-between items-center text-xs lg:text-sm">
                <div className="flex items-center">
                  <span className="w-2.5 lg:w-3 h-2.5 lg:h-3 rounded-full bg-teal-500 mr-2 lg:mr-3"></span>
                  <span className="font-semibold text-gray-600">Senior (11-20 Thn)</span>
                </div>
                <span className="font-bold bg-gray-100 px-2 rounded">{masaKerjaStats["11-20 Thn"]}</span>
              </div>
              <div className="flex justify-between items-center text-xs lg:text-sm">
                <div className="flex items-center">
                  <span className="w-2.5 lg:w-3 h-2.5 lg:h-3 rounded-full bg-rose-500 mr-2 lg:mr-3"></span>
                  <span className="font-semibold text-gray-600">Veteran (&gt; 20 Thn)</span>
                </div>
                <span className="font-bold bg-gray-100 px-2 rounded">{masaKerjaStats["> 20 Thn"]}</span>
              </div>
            </div>
          </div>
          <div className="relative w-40 h-40 lg:w-48 lg:h-48 rounded-full flex items-center justify-center shadow-lg order-1 md:order-2 shrink-0" style={{ background: totalASN > 0 ? mkGradient : "#f3f4f6" }}>
            <div className="absolute w-28 h-28 lg:w-36 lg:h-36 bg-white rounded-full flex flex-col items-center justify-center shadow-inner">
              <span className="text-2xl lg:text-3xl font-black text-gray-800">{totalASN}</span>
              <span className="text-[9px] lg:text-[10px] font-bold text-gray-400 uppercase tracking-widest text-center mt-0.5 lg:mt-1">
                ASN<br />Dianalisa
              </span>
            </div>
          </div>
      ...
      {/* BARIS 4: PENSIUN, RADAR KP, KOMPOSISI STATUS */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 animate-fade-up delay-400">
        <div className="glass-card rounded-3xl shadow-sm border border-gray-100 p-6 lg:p-8">
          <h2 className="text-base lg:text-lg font-bold text-gray-800 mb-5 lg:mb-6 flex items-center">
            <span className="w-2.5 lg:w-3 h-5 lg:h-6 bg-rose-500 rounded-full mr-2 lg:mr-3"></span> Proyeksi Pensiun
          </h2>
          <div className="space-y-3 lg:space-y-4">
            {Object.entries(pensiunStats).map(([range, count], idx) => {
              ...
              return (
                <div key={idx}>
                  <div className="flex justify-between text-[11px] lg:text-xs mb-1 lg:mb-1.5 font-bold">
                    <span className="text-gray-600">{range}</span>
                    <span className={textColor}>{count} Org</span>
                  </div>
                  <div className="w-full bg-gray-100 rounded-full h-2.5 lg:h-3 overflow-hidden">
                    <div className={`h-full bg-gradient-to-r ${barColor} rounded-full animate-bar`} style={{ width: `${widthPct}%` }}></div>
                  </div>
                </div>
              );
            })}
        ...
        <div className="glass-card rounded-3xl shadow-sm border border-gray-100 p-6 lg:p-8 flex flex-col h-[300px] lg:h-[320px]">
          <h2 className="text-base lg:text-lg font-bold text-gray-800 mb-1 lg:mb-2 flex items-center">
            <span className="w-2.5 lg:w-3 h-5 lg:h-6 bg-[#15406A] rounded-full mr-2 lg:mr-3"></span> Radar Kenaikan Pangkat
          </h2>
          ...
          <div className="flex-1 overflow-y-auto space-y-2 lg:space-y-3 pr-1 lg:pr-2 scrollbar-thin">
            {kandidatKP.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-gray-400">
                <span className="text-[11px] lg:text-xs font-medium">Semua data KP aman.</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="glass-card rounded-3xl shadow-sm border border-gray-100 p-6 lg:p-8 flex flex-col items-center justify-between md:col-span-2 lg:col-span-1">
          <h2 className="text-base lg:text-lg font-bold text-gray-800 w-full mb-4 lg:mb-6 flex items-center">
            <span className="w-2.5 lg:w-3 h-5 lg:h-6 bg-amber-500 rounded-full mr-2 lg:mr-3"></span> Komposisi Status
          </h2>
          <div className="relative w-36 h-36 lg:w-44 lg:h-44 rounded-full flex items-center justify-center shadow-lg group shrink-0" style={{ background: totalPegawai > 0 ? donutGradient : "#f3f4f6" }}>
            <div className="absolute w-24 h-24 lg:w-28 lg:h-28 bg-white rounded-full flex flex-col items-center justify-center shadow-inner group-hover:scale-95 transition-transform duration-500">
              <span className="text-2xl lg:text-3xl font-black text-[#15406A]">{totalPegawai}</span>
              <span className="text-[9px] lg:text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-0.5">Total</span>
            </div>
          </div>
          <div className="mt-5 lg:mt-6 w-full flex justify-around text-center">
            <div>
              <div className="w-2.5 h-2.5 lg:w-3 lg:h-3 rounded-full bg-emerald-500 mx-auto mb-1"></div>
              <p className="text-[10px] lg:text-xs text-gray-500 font-bold">PNS</p>
              <p className="text-sm lg:text-base font-black text-gray-800">{Math.round(pnsPct)}%</p>
            </div>
            <div>
              <div className="w-2.5 h-2.5 lg:w-3 lg:h-3 rounded-full bg-blue-500 mx-auto mb-1"></div>
              <p className="text-[10px] lg:text-xs text-gray-500 font-bold">PPPK</p>
              <p className="text-sm lg:text-base font-black text-gray-800">{Math.round(pppkPct)}%</p>
            </div>
            <div>
              <div className="w-2.5 h-2.5 lg:w-3 lg:h-3 rounded-full bg-amber-500 mx-auto mb-1"></div>
              <p className="text-[10px] lg:text-xs text-gray-500 font-bold">Non ASN</p>
              <p className="text-sm lg:text-base font-black text-gray-800">{Math.round(nonAsnPct)}%</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* BARIS 5: GOLONGAN */}
      <div className="animate-fade-up delay-500 glass-card rounded-3xl shadow-sm border border-gray-100 p-6 lg:p-8">
        ...
        <div className="flex h-48 lg:h-64 items-end space-x-1 sm:space-x-2 md:space-x-8 border-b-2 border-l-2 border-gray-100 pb-2 pl-1 lg:pl-2 relative overflow-x-auto overflow-y-hidden">
          <div className="absolute w-full border-t border-dashed border-gray-200 top-0 left-1 lg:left-2"></div>
          ...
          {Object.entries(golonganStats).map(([golongan, count], index) => {
            ...
            return (
              <div key={index} className="flex-1 min-w-[40px] flex flex-col items-center group z-10 h-full justify-end relative">
                <div className="absolute -top-8 lg:-top-10 opacity-0 group-hover:opacity-100 transition-all duration-300 bg-gray-800 text-white text-[10px] lg:text-xs font-bold px-2 lg:px-3 py-1 lg:py-1.5 rounded-lg pointer-events-none transform translate-y-2 group-hover:translate-y-0 shadow-lg whitespace-nowrap z-20">
                  {count} Orang
      ...
      {/* BARIS 6 & 7: MATRIKS TABEL (Horizontal Scroll) */}
            ...
            <table className="w-full text-left border-collapse whitespace-nowrap min-w-[800px]">
              <thead>
                <tr className="bg-gray-100/80 border-y-2 border-gray-200">
                  <th className="px-3 lg:px-5 py-3 lg:py-5 text-[10px] lg:text-xs font-black text-gray-600 uppercase tracking-wider sticky left-0 bg-gray-100 z-10">Jenjang Jabatan</th>
                  {kategoriList.map((k) => (
              ...
              <tbody className="divide-y divide-gray-100">
                {jenjangList.map((j) => (
                  <tr key={j} className="hover:bg-purple-50/40 transition-colors group">
                    <td className="px-3 lg:px-5 py-3 lg:py-4 font-bold text-gray-700 text-xs lg:text-sm border-r border-gray-100 group-hover:text-purple-700 sticky left-0 bg-white group-hover:bg-purple-50/40 transition-colors z-10">{j}</td>
                    {kategoriList.map((k) => {
                ...
                <tr className="bg-gray-100/80 border-t-4 border-gray-200">
                  <td className="px-3 lg:px-5 py-3 lg:py-5 font-black text-gray-800 uppercase text-[10px] lg:text-xs border-r border-gray-200 sticky left-0 bg-gray-100 z-10">Total Kolom</td>
                  {kategoriList.map((k) => (
        ...
        <div className="glass-card rounded-3xl shadow-lg border border-gray-200/60 p-5 lg:p-8 overflow-hidden mb-6 lg:mb-10">
          ...
          <div className="overflow-x-auto pb-4 -mx-5 px-5 lg:mx-0 lg:px-0">
            <table className="w-full text-left border-collapse whitespace-nowrap min-w-[600px]">
              <thead>
                <tr className="bg-gray-100/80 border-y-2 border-gray-200">
                  <th className="px-3 lg:px-5 py-3 lg:py-5 text-[10px] lg:text-xs font-black text-gray-600 uppercase tracking-wider w-[40%] lg:w-1/2 sticky left-0 bg-gray-100 z-10">Nama Jabatan Pelaksana</th>
                  <th className="px-2 lg:px-4 py-3 lg:py-5 text-[9px] lg:text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center border-l border-gray-200/50">BBPVP Makassar (Pusat)</th>
                  <th className="px-2 lg:px-4 py-3 lg:py-5 text-[9px] lg:text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center border-l border-gray-200/50">Penempatan SATPEL</th>
                  <th className="px-3 lg:px-4 py-3 lg:py-5 text-[10px] lg:text-[11px] font-black text-[#15406A] uppercase tracking-wider text-center bg-blue-100/50 border-l-2 border-blue-200">Total Keseluruhan</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                {pelaksanaList.map((jab) => (
                  <tr key={jab} className="hover:bg-orange-50/40 transition-colors group">
                    <td className="px-3 lg:px-5 py-3 lg:py-4 font-bold text-gray-700 text-xs lg:text-sm border-r border-gray-100 group-hover:text-orange-700 sticky left-0 bg-white group-hover:bg-orange-50/40 transition-colors z-10 whitespace-normal min-w-[200px] lg:min-w-0">{jab}</td>
                    ...
                    <td className="px-3 lg:px-4 py-3 lg:py-4 text-center font-black text-[#15406A] bg-blue-50/30 border-l-2 border-blue-100 text-sm lg:text-base">{pelaksanaStats[jab].total}</td>
                  </tr>
                ))}
                <tr className="bg-gray-100/80 border-t-4 border-gray-200">
                  <td className="px-3 lg:px-5 py-3 lg:py-5 font-black text-gray-800 uppercase text-[10px] lg:text-xs border-r border-gray-200 text-right sticky left-0 bg-gray-100 z-10">Grand Total</td>
                  ...
                  <td className="px-3 lg:px-4 py-3 lg:py-5 text-center font-black text-white bg-[#15406A] text-lg lg:text-xl shadow-inner">{totalPelaksanaKeseluruhan}</td>
                </tr>
              </tbody>
            </table>
          </div>

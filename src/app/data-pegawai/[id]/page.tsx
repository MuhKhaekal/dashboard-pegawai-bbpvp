    ...
    <div className="p-4 md:p-6 md:px-24 mx-auto space-y-6 bg-slate-50 min-h-screen">
      ...
      <div className="animate-fade-up flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2">
        ...
        <div className="flex gap-2">
          <Link href="/" className="px-5 py-2.5 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 rounded-xl font-bold text-sm transition-all shadow-sm flex items-center gap-2">
            Kembali
          </Link>
        </div>
      </div>

...
export default async function DashboardDetailPage({
  ...
  // Filter yang sedang aktif di Dashboard utama
  const baseStatus = params.baseStatus || "";
  const baseUnit = params.baseUnit || "";
  const baseSearch = params.baseSearch || "";
  ...
  const data: Pegawai[] = pegawaiRows.map((pegawai) => ({
    ...(pegawai as Pegawai),
